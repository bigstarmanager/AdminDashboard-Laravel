...
Route::get('/home', [DashboardController::class, 'dashboardHome']);
...
// Page Route
Route::get('/page-notification-management', [PageController::class, 'notificationPage']);
Route::get('/page-language-list', [PageController::class, 'languageList']);
Route::get('/page-language-edit', [PageController::class, 'languageEdit']);
...
// user & admin Route
Route::get('/page-admin-list', [UserController::class, 'adminList']);
Route::get('/page-admin-view', [UserController::class, 'adminView']);
Route::get('/page-admin-edit', [UserController::class, 'adminEdit']);
...
Route::get('/page-discount-list', [UserController::class, 'discountList']);
Route::get('/page-discount-view', [UserController::class, 'discountView']);
Route::get('/page-discount-edit', [UserController::class, 'discountEdit']);

// city management Route
Route::get('/page-city-list', [UserController::class, 'cityList']);
Route::get('/page-city-edit', [UserController::class, 'cityEdit']);


// banner managemetn Route
Route::get('/page-banner-list', [UserController::class, 'bannerList']);
Route::get('/page-banner-edit', [UserController::class, 'bannerEdit']);

// banner managemetn Route
Route::get('/page-restaurant-list', [UserController::class, 'restaurantList']);
Route::get('/page-restaurant-edit', [UserController::class, 'restaurantEdit']);
Route::get('/page-apptext-edit', [UserController::class, 'appTextEdit']);
...
Route::get('/table-new-orders', [DataTableController::class, 'newDataTableOrders']);
Route::get('/table-cancelled-orders', [DataTableController::class, 'cancelledDataTableOrders']);
Route::get('/table-completed-orders', [DataTableController::class, 'completedDataTableOrders']);
Route::get('/table-running-orders', [DataTableController::class, 'runningDataTableOrders']);

// Form Route
Route::get('/form-report-management', [FormController::class, 'reportManagement']);
Route::get('/form-page-editor', [FormController::class, 'formPageEditor']);
