...
return [
    'custom' => [
        'mainLayoutType' => 'horizontal-menu', //'vertical-modern-menu', //Options:vertical-modern-menu,vertical-menu-nav-dark,vertical-gradient-menu,vertical-dark-menu,horizontal-menu, default(vertical-modern-menu)
        ...
        'navbarBgColor' => 'gradient-45deg-deep-purple-blue', //Options: cyan,teal,light-blue,amber (any of materializecolor class can be pass). warning:if isNavbarDark set NavbarBgColor not work.
        ...
        'smallScreenLogo' => 'images/instadrink_img/logo.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
