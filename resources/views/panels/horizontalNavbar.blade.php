  ...
  <nav
    ...
    <div class="nav-wrapper">
        ...
        <li>
          <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{asset('/')}}">
              <img src="{{asset($configData['smallScreenLogo'])}}" alt="instadrink_logo">
      ...
      <div class="header-search-wrapper hide-on-med-and-down">
        ...
        <input class="header-search-input z-depth-2" type="text" name="Search" placeholder="Enter Order ID or Customer Phone Number"
