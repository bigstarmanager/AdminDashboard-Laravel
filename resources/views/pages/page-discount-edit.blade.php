...
{{-- page title --}}
@section('title','Discount offer edit')
              ...
              <div class="col s12 m6">
                <div class="row">
                  ...
                  <div class="col s6 input-field">
                    <input id="email" name="email" type="email" class="validate" value="10"
                      data-error=".errorTxt3">
                    <label for="email">Discount Value</label>
                    <small class="errorTxt3"></small>
                  </div>
                  <div class="col s6 input-field">
                    <input id="email" name="email" type="email" class="validate" value="50">
